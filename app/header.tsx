...
// Modal komponentini import qilamiz
...
const Header: React.FC<HeaderProps> = ({ className }) => {
    ...
    const handleClick = () => {
        setOpen(!open); // Modal ochilishi/yoqilishi
    };
    ...
    return (
        <div className={className}>
            <div className="header-top">
                <div className="logo">
                    <button>open modll</button>
                    <Image onClick={handleClick} src="/logo.svg" alt="My Image" width={143} height={25} />
                </div>
                <div className="menu">
                    <Link href='/'>HOME </Link>
            ...
            {/* Modal */}
            <BasicModal open={open} onClose={handleClick} /> {/* Modalni ko'rsatish */}
        </div>
    )
}
